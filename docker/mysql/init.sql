-- LyEdu 数据库初始化脚本
-- 允许从本机客户端（经 Docker 端口转发）连接：root@'%' + 传统认证，便于 Navicat/DBeaver 等连接
CREATE USER IF NOT EXISTS 'root'@'%' IDENTIFIED WITH mysql_native_password BY 'lyedu123456';
GRANT ALL PRIVILEGES ON *.* TO 'root'@'%' WITH GRANT OPTION;
ALTER USER 'root'@'localhost' IDENTIFIED WITH mysql_native_password BY 'lyedu123456';
FLUSH PRIVILEGES;
